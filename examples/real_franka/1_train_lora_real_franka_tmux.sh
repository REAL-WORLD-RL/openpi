...
tmux send-keys -t $SESSION_NAME "echo '  Config: pi05_libero_real_franka_lora' " C-m
...
tmux send-keys -t $SESSION_NAME "uv run scripts/compute_norm_stats.py --config-name pi05_libero_real_franka_lora && echo '' && echo '步骤2: 开始训练...' && uv run scripts/train.py pi05_libero_real_franka_lora --exp-name lora_libero_real_franka_pickup_100demos --overwrite" C-m
